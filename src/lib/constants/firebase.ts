import { FirebaseAuth, FirebaseDatabase, FirebaseFirestore, FirebaseStorage, type FirebaseOptions } from '@radar-azdelta-int/radar-firebase-utils'
import {
...
export const realtimeDatabase = new FirebaseDatabase(firebaseConfig)
